...
(use-package lsp-mode
  ...
  ;;       (js-mode . lsp))
  :init
  (setq lsp-prefer-flymake :none)) ;; FIXME: :none disables both flymake and flycheck. Set it to nil to use flycheck. Also set to :none for only web-mode and js-mode because I use eslint there.
...
** dashboard
#+BEGIN_SRC emacs-lisp
;; Optional dependency of the dashboard
;; You need to run this after installing the package: (all-the-icons-install-fonts)
...
(use-package dashboard
  :ensure t
  :init
  (setq initial-buffer-choice (lambda () (get-buffer "*dashboard*")) ;; Dashboard setting for daemon mode
        dashboard-banner-logo-title "Welcome to Emacs, boi"
  ...
  (progn
    ...
    (add-hook 'dashboard-mode-hook (lambda ()
      (define-key dashboard-mode-map "j" 'next-line)
      (define-key dashboard-mode-map "k" 'previous-line))) ;; Add evil keys
