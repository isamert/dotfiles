...
(use-package lsp-ui
  ...
  (evil-define-key 'insert lsp-ui-peek-mode-map
    "gf" 'lsp-ui-peek-find-references
    (kbd "j") 'lsp-ui-peek--select-next
    (kbd "k") 'lsp-ui-peek--select-prev
    (kbd "l") 'lsp-ui-peek--select-next-file
    (kbd "h") 'lsp-ui-peek--select-prev-file))
