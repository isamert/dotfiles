...
(use-package npm-mode
  :ensure t
  :hook ((js-mode js2-mode js-jsx-mode js2-jsx-mode web-mode) . npm-mode)
  :config
  (evil-leader/set-key-for-mode 'npm-mode
    "nr" 'npm-mode-npm-run
...
(use-package evil-leader
  ...
  (progn
    ...
    (evil-leader/set-key
      ...
      "hh" 'helm-resume
      "hr" 'helm-rg
      "hp" 'helm-projectile-rg-current-project
      "hm" 'helm-my-files
...
** helm extensions
#+begin_src emacs-lisp
(defun helm-projectile-rg-current-project nil
...
(defun helm-projectile-rg-all-projects nil
...
(defun helm-grep-ag-current-project (arg)
  "Search in current project using ag"
  (interactive "P")
  (helm-grep-ag (projectile-project-root) arg))

(defun helm-grep-git-grep-current-project (arg)
  "Search in current project using ag"
  (interactive "P")
